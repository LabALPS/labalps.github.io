...
Please prepare your manuscript using the official [Interspeech 2026 template](https://drive.google.com/file/d/1Nq1j_1AfOtadLkBx71-vLVLxZOaiAnzs/view) for regular papers. 
The maximum number of manuscript pages is 6, pages 5 and 6 are reserved exclusively for acknowledgments, disclosures of the use of generative AI tools, and references, which may begin on an earlier page if space permits.
You are free to use LaTeX or Word, please submit a single PDF file.
